...
const categoryMeta = [
  { key: "frontend",    title: "Frontend Engineering",       icon: Palette,  accent: "text-cyan-400",   bg: "bg-cyan-950/40",   border: "border-cyan-500/30" },
  { key: "backend",     title: "Backend Systems",            icon: Server,   accent: "text-blue-400",   bg: "bg-blue-950/40",   border: "border-blue-500/30" },
  { key: "database",    title: "Database Architectures",     icon: Database, accent: "text-teal-400",   bg: "bg-teal-950/40",   border: "border-teal-500/30" },
  { key: "programming", title: "Programming Languages",      icon: Terminal, accent: "text-sky-400",    bg: "bg-sky-950/40",    border: "border-sky-500/30" },
  { key: "tools",       title: "Developer Tools",            icon: Wrench,   accent: "text-indigo-400", bg: "bg-indigo-950/40", border: "border-indigo-500/30" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-slate-400 text-base sm:text-lg mt-3">
            A comprehensive overview of my tech stack, frameworks, and developer ecosystem.
          </p>
